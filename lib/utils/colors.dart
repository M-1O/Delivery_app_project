...
class AppColors {
  ...
  static const Color mainColor = Colors.redAccent; //Color(0xFF89dad0);
  static const Color iconColor1 = Colors.amberAccent; //Color(0xFFffd28d);
  static const Color iconColor2 = Colors.red; //Color(0xFFfcab88);
